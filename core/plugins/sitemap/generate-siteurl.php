...
$skip = array(
    $start_url . "/assets/backend/v1",
    $start_url . "/core/",
    $start_url . "/frontend/templates_c/",
    $start_url . "/.htpasswd",
    $start_url . "/referencement.txt",
    $start_url . "/notes.txt",
);
...
function GetUrl($url) {
    $agent = "Mozilla/5.0 (compatible; iProDev PHP XML Sitemap Generator/" . VERSION . ", " . HTTP_PATH . ")";
...
function Scan($url) {
    global $start_url, $scanned, $extension, $skip;
...
fwrite($pf, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" .
        "<!-- Created with iProDev PHP XML Sitemap Generator " . VERSION . " " . HTTP_PATH . " -->\n" .
