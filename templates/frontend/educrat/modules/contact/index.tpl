					...
					<div class="y-gap-30 pt-60 lg:pt-40">
						...
						<div class="d-flex items-center">
							<div class="d-flex justify-center items-center size-60 rounded-full bg-light-7">
								<img src="{_FEIMG_}/contact-1/1.svg" alt="icon">
							</div>
							<div class="ml-20">{__ADRESSE} {__CP} {__VILLE}</div>
						</div>

						<div class="d-flex items-center">
							<div class="d-flex justify-center items-center size-60 rounded-full bg-light-7">
								<img src="{_FEIMG_}/contact-1/2.svg" alt="icon">
							</div>
							<div class="ml-20">{__TELEPHONE}</div>
						</div>

						<div class="d-flex items-center">
							<div class="d-flex justify-center items-center size-60 rounded-full bg-light-7">
								<img src="{_FEIMG_}/contact-1/3.svg" alt="icon">
							</div>
							<div class="ml-20">{__WEBMAIL}</div>
						</div>
