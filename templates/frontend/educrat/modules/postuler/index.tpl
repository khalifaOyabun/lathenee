<div class="barba-container" data-barba="container">
					...
					<div class="dashboard__content bg-light-4">
						<div class="row pb-50 mb-10">
							<div class="col-auto">
								...
								<h1 class="text-30 lh-12 fw-700 role_title">{$assigned.role}</h1>
							...
							<div class="col-xl-7 mailbox">
								<div class="rounded-16 bg-white -dark-bg-dark-1 shadow-4 h-100">
									<div class="d-flex justify-between p-3">
										...
										<div>
											<span class="replace" id="ville">Dakar</span>, le {$assigned.today}
										</div>
									</div>
									...
									<div class="p-5">
										...
										poste de {$assigned.role}, que vous proposez sur www.lathenee.sn. Les
	...
	{elseif isset($assigned.error)}
		...
		<div class="modal-container m-100">
			<div class="overlay"></div>
			<div class="modal">
				<div class="d-grid gap-2">
					<h1>{$assigned.error}</h1>
					<button type="button" name="" id=""
						class="close-modal modal-trigger button -md bg-red-3 text-white">OK</button>
				</div>
			</div>
		</div>
	{elseif isset($assigned.erreur)}
		<main class="main-content">
