<?php
/* Smarty version 3.1.32, created on 2022-11-20 14:15:38
  from '/Applications/XAMPP/xamppfiles/htdocs/plateformes/amarys/lathenee/templates/frontend/educrat/modules/actualite/index.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_637a287aaabdd2_94404387',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'c1ba2d7c72b5ab74bb68a00c6208727945340549' => 
    array (
      0 => '/Applications/XAMPP/xamppfiles/htdocs/plateformes/amarys/lathenee/templates/frontend/educrat/modules/actualite/index.tpl',
      1 => 1656284296,
      2 => 'file',
    ),
  ),
...
function content_637a287aaabdd2_94404387 (Smarty_Internal_Template $_smarty_tpl) {
				...
				<div class="col-lg-7">
					...
					<form class="contact-form row y-gap-30 pt-60 lg:pt-40" action="#">
						<div class="col-md-6">
							...
							<input type="text" name="title" placeholder="Nom & Prénom ...">
						</div>
						<div class="col-md-6">
					...
					<div class="accordion -block text-left pt-60 lg:pt-40 js-accordion">
						...
						<div class="accordion__item">
							<div class="accordion__button">
								...
								<span class="text-17 fw-500 text-dark-1">Do you offer discounts for
									students?</span>
							</div>
						...
						<div class="accordion__item">
							<div class="accordion__button">
								...
								<span class="text-17 fw-500 text-dark-1">Do you offer special pricing for
									big teams?</span>
							</div>
						...
						<div class="accordion__item">
							<div class="accordion__button">
								...
								<span class="text-17 fw-500 text-dark-1">What is the past experience of your
									teachers?</span>
							</div>
						...
						<div class="accordion__item">
							<div class="accordion__button">
								...
								<span class="text-17 fw-500 text-dark-1">What is the course refund
									policy?</span>
							</div>
				...
				<div class="row y-gap-20 justify-between items-center">
					<div class="col-auto">
						<div class="footer-header__logo">
							<img src="<?php echo _FEIMG_;?>
/footer/footer-logo.svg" alt="logo">
						</div>
					</div>
					<div class="col-auto">
						<div class="footer-header-socials">
							<div class="footer-header-socials__title text-white">Follow us on social media
							</div>
