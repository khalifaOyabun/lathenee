...
function sendMail($nameFrom, $from, $to, $subject, $body, $nameTo = null, $fichiersJoints = null, $ical_content = "")
{
    ...
    $mail->Port = 587;//ou 25
    $mail->Username = "152c14b582e5b9f873fd8611b3c6c920";
    $mail->Password = "3f5632aaa4e5a18a96d67ca4abb2130a"; // GMAIL password
    
    $sender = 'no-reply@horeca.fr';
    ...
    if ($from) {
        ...
        $mail->SetFrom('no-reply@horeca.fr', 'Service Informations');
        $mail->AddReplyTo("no-reply@horeca.fr", "Service Informations");
    }
    if (defined('BCC_MAIL')) {
